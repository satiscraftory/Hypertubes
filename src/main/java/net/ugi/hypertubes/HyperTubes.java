...
@Mod(net.ugi.hypertubes.HyperTubes.MOD_ID)
public class HyperTubes {
    public static final String MOD_ID = "hypertubes";
    ...
    public HyperTubes(IEventBus modEventBus, ModContainer modContainer) {
...
/*.setId(ResourceKey.create(ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(MOD_ID,"hypertube_block")),ResourceLocation.fromNamespaceAndPath(MOD_ID,"hypertube_block")))*//*
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.hypertubess"))
